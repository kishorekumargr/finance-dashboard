function Cards() {
  return (
    <div className="grid grid-cols-2 gap-4">
      <div
        className="rounded-xl text-white px-5 py-10 bg-linear-to-br from-[#6EE7F9] to-[#A78BFA]
 shadow-lg"
      >
      ...
      <div className="rounded-xl text-white p-5 py-10 bg-linear-to-br from-[#FBCFE8] to-[#93C5FD] shadow-lg">
